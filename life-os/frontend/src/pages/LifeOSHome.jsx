...
export default function LifeOSHome() {
  ...
  return (
    ...
    >
      ...
      {/* ===== HERO GREETING ===== */}
      <motion.div variants={itemVariants} style={{ marginBottom: isMobile ? 24 : 48 }}>
        ...
        <div style={{
          ...
          {[
            { label: 'Streak', value: `${stats.habits?.longestCurrentStreak ?? 0}🔥`, icon: Flame, color: '#f59e0b' },
            { label: 'Tasks Done', value: stats.todos?.completedTasks ?? 0, icon: Target, color: '#34d399' },
            { label: 'Rate', value: `${Math.round(stats.todos?.completionRate ?? 0)}%`, icon: TrendingUp, color: '#a78bfa' },
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: isMobile ? 10 : 12, color: '#6b7280' }}>
                  {label}
                </div>
              </div>
            </motion.div>
      ...
      >
        <Star size={18} color="#a78bfa" style={{ flexShrink: 0, marginTop: 2 }} />
        <p style={{
